...
const Game = () => {
	...
	// If we don't have anything in the local storage
	...
	return (
		<div className='Game'>
			...
			{showNoSolutionFoundModal && (
				<NoSolutionFoundModal closeModal={() => setShowNoSolutionFoundModal((show) => !show)} />
			)}
			...
			<div className='action-container'>
				<Button onClick={handleClearBoard} buttonStyle='btn--primary--solid' text='Clear' />
				<Button onClick={handleSolve} buttonStyle='btn--success--solid' text='Solve' />
				<Button onClick={handleHint} buttonStyle='btn--warning--solid' text='Hint' />
				<Button
